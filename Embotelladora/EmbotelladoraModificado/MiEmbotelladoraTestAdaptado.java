...
public class MiEmbotelladoraTestAdaptado
{
	...
	//Adapto con su declaración privada "litros" 
	@Before 
    public void setUp()
    {
	...
	public void negativeTest()
	{
		...
		grandes = 0;
		total = 3;
		litros.calcBotellasPequenyas(pequenas, grandes, total);
	}
	...
	public void b2Test()
	{
		...
		grandes = 1;
		total = 20;
		assertTrue ("b3Test", litros.calcBotellasPequenyas(pequenas, grandes, total) == 0);
	}
	...
	public void b4Test()
	{
		...
		grandes = 1;
		total = 7;
		assertTrue ("b4Test", litros.calcBotellasPequenyas(pequenas, grandes, total) == 2);
	}
	...
	public void b5Test()
	{
		...
		grandes = 4;
		total = 20;
		assertTrue ("b5Test", litros.calcBotellasPequenyas(pequenas, grandes, total) == 0);
	}
}
